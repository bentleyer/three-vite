...
const camShift = new THREE.Vector3(0, 7, 0);
...
const maxHeight = 20;
const depthData = new DepthData(1024, { width: 20, height: 20, depth: maxHeight });
...
const rain = new Rain(new THREE.Vector3(20, 20, 20), 50000);
scene.add(rain);
