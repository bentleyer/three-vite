...
module.exports = {
    ...
    rules: {
        ...
        'array-bracket-spacing': [ 'error', 'always' ], // 要求数组方括号中使用一致的空格
        'object-curly-spacing': [ 'error', 'always' ], // 要求数组方括号中使用一致的空格
        'computed-property-spacing': [ 'error', 'never' ], // 要求数组方括号中使用一致的空格
        'comma-spacing': [ 'error', { 'before': false, 'after': true } ], // 要求数组方括号中使用一致的空格
        'keyword-spacing': [ 'error', { 'before': true, 'after': true } ], // 要求数组方括号中使用一致的空格
        'brace-style': 'warn', // 要求在代码块中使用一致的大括号风格
        'camelcase': 'off', // 要求使用骆驼拼写法命名约定
        'indent': [ 'warn', 4 ], // 要求使用JS一致缩进4个空格
        'max-depth': [ 'warn', 5 ], // 要求可嵌套的块的最大深度4
        'max-statements': [ 'warn', 300 ], // 要求函数块最多允许的的语句数量20
